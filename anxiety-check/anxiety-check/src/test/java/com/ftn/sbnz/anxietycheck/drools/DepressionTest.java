...
public class DepressionTest {
    ...
    public void setup() {
        ...
        ps.add(PredominantSymptoms.RelivingOfPast);
    ...
    public void depression_PTSD() {
        ...
        assertEquals(user.getDepression().getName(),"Depression caused by PTSD");
